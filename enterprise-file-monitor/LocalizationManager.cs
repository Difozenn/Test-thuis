    ...
    public class LocalizationManager
    {
        ...
        private void InitializeTranslations()
        {
            translations = new Dictionary<string, Dictionary<string, string>>
            {
                ...
                {
                    // Application
                    ["app_title"] = "CNC Datalog",
                    ["app_running"] = "CNC Datalog is running in the system tray",
                    ["already_running"] = "CNC Datalog is already running in the system tray.",
                    ...
                    // Tooltips
                    ["tooltip_not_logged_in"] = "CNC Datalog - Not logged in",
                    ["tooltip_logged_in"] = "CNC Datalog - {0} ({1})",
                    
                    // CNC Analyzer
                    ["analyzer_mode"] = "CNC Analyzer Mode",
                    ["simple_analyzer"] = "Simple (Basic)",
                    ["enhanced_analyzer"] = "Enhanced (Advanced)",
                    ["auto_analyzer"] = "Auto (Enhanced with fallback)",
                    ["select_pp_ini"] = "Select PP.ini File...",
                    ["pp_ini_title"] = "Select PP.ini Configuration File",
                    ["pp_ini_filter"] = "INI Files (*.ini)|*.ini",
                    ["pp_ini_selected"] = "PP.ini file selected: {0}",
                    ["pp_ini_not_found"] = "PP.ini file not found: {0}",
                    ["pp_ini_cleared"] = "PP.ini configuration cleared",
                    ["analyzer_mode_changed"] = "Analyzer mode changed to: {0}",
                    ["analyzer_fallback"] = "Enhanced analyzer failed, falling back to simple analyzer"
                },
                ...
                ["nl"] = new Dictionary<string, string>
                {
                    // Application
                    ["app_title"] = "CNC Datalog",
                    ["app_running"] = "CNC Datalog draait in het systeemvak",
                    ["already_running"] = "CNC Datalog draait al in het systeemvak.",
                    ...
                    // Tooltips
                    ["tooltip_not_logged_in"] = "CNC Datalog - Niet ingelogd",
                    ["tooltip_logged_in"] = "CNC Datalog - {0} ({1})",
                    
                    // CNC Analyzer
                    ["analyzer_mode"] = "CNC Analyzer Modus",
                    ["simple_analyzer"] = "Eenvoudig (Basis)",
                    ["enhanced_analyzer"] = "Geavanceerd (Uitgebreid)",
                    ["auto_analyzer"] = "Auto (Geavanceerd met terugval)",
                    ["select_pp_ini"] = "Selecteer PP.ini Bestand...",
                    ["pp_ini_title"] = "Selecteer PP.ini Configuratiebestand",
                    ["pp_ini_filter"] = "INI Bestanden (*.ini)|*.ini",
                    ["pp_ini_selected"] = "PP.ini bestand geselecteerd: {0}",
                    ["pp_ini_not_found"] = "PP.ini bestand niet gevonden: {0}",
                    ["pp_ini_cleared"] = "PP.ini configuratie gewist",
                    ["analyzer_mode_changed"] = "Analyzer modus gewijzigd naar: {0}",
                    ["analyzer_fallback"] = "Geavanceerde analyzer mislukt, terugvallen op eenvoudige analyzer"
                }
            };
        }
    }
